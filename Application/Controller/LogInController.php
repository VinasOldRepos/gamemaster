...
*************************************************************************************/
	...
	Final class LogInController {
		...
		public function __construct() {
			...
			$GLOBALS['this_js']		= '<script type="text/javascript" src="/gamemaster/Application/View/js/scripts/login.js"></script>'.PHP_EOL;	// Se não houver, definir como vazio ''
		...
		*/
		public static function checkLogin() {
			...
			return ($user['rights']['boo_gamemaster']) ? true : false;
		}
