	...
	class User {
		...
		private	function resultHeader($ordering = 'u.id', $direction = 'ASC') {
			...
			if (($ordering == 'u.id') && ($direction == 'ASC')) {
				$return	.= '	<div class="result_header_field result_id" key="u.id" direction="DESC"><img src="/gamemaster/Application/View/img/arrow_down_mini.gif" width="16" height="16" align="absmiddle" />ID</div>'.PHP_EOL;
			} else if (($ordering == 'u.id') && ($direction == 'DESC')) {
				$return	.= '	<div class="result_header_field result_id" key="u.id" direction="ASC"><img src="/gamemaster/Application/View/img/arrow_up_mini.gif" width="16" height="16" align="absmiddle" />ID</div>'.PHP_EOL;
			} else {
				$return	.= '	<div class="result_header_field result_id" key="u.id" direction="ASC">ID</div>'.PHP_EOL;
			}
			if (($ordering == 'u.vc_user') && ($direction == 'ASC')) {
				$return	.= '	<div class="result_header_field result_user"  key="u.vc_user" direction="DESC" style="text-align: center;"><img src="/gamemaster/Application/View/img/arrow_down_mini.gif" width="16" height="16" align="absmiddle" />User</div>'.PHP_EOL;
			} else if (($ordering == 'u.vc_user') && ($direction == 'DESC')) {
				$return	.= '	<div class="result_header_field result_user"  key="u.vc_user" direction="ASC" style="text-align: center;"><img src="/gamemaster/Application/View/img/arrow_up_mini.gif" width="16" height="16" align="absmiddle" />User</div>'.PHP_EOL;
			} else {
			...
			if (($ordering == 'u.vc_email') && ($direction == 'ASC')) {
				$return	.= '	<div class="result_header_field result_email"  key="u.vc_email" direction="DESC" style="text-align: center;"><img src="/gamemaster/Application/View/img/arrow_down_mini.gif" width="16" height="16" align="absmiddle" />Email</div>'.PHP_EOL;
			} else if (($ordering == 'u.vc_email') && ($direction == 'DESC')) {
				$return	.= '	<div class="result_header_field result_email"  key="u.vc_email" direction="ASC" style="text-align: center;"><img src="/gamemaster/Application/View/img/arrow_up_mini.gif" width="16" height="16" align="absmiddle" />Email</div>'.PHP_EOL;
			} else {
			...
			if (($ordering == 'p.vc_profile') && ($direction == 'ASC')) {
				$return	.= '	<div class="result_header_field result_profile"  key="p.vc_profile" direction="DESC" style="text-align: center;"><img src="/gamemaster/Application/View/img/arrow_down_mini.gif" width="16" height="16" align="absmiddle" />Profile</div>'.PHP_EOL;
			} else if (($ordering == 'p.vc_profile') && ($direction == 'DESC')) {
				$return	.= '	<div class="result_header_field result_profile"  key="p.vc_profile" direction="ASC" style="text-align: center;"><img src="/gamemaster/Application/View/img/arrow_up_mini.gif" width="16" height="16" align="absmiddle" />Profile</div>'.PHP_EOL;
			} else {
			...
			if (($ordering == 'u.boo_active') && ($direction == 'ASC')) {
				$return	.= '	<div class="result_header_field result_active"  key="u.boo_active" direction="DESC" style="text-align: center;"><img src="/gamemaster/Application/View/img/arrow_down_mini.gif" width="16" height="16" align="absmiddle" />Status</div>'.PHP_EOL;
			} else if (($ordering == 'u.boo_active') && ($direction == 'DESC')) {
				$return	.= '	<div class="result_header_field result_active"  key="u.boo_active" direction="ASC" style="text-align: center;"><img src="/gamemaster/Application/View/img/arrow_up_mini.gif" width="16" height="16" align="absmiddle" />Status</div>'.PHP_EOL;
			} else {
